...
Economic performance is caused by institution, with colonial origins.
...
* Coding agents can speed up coding, researching, writing.
* They can make mistakes (!), we should check their results.
* Good judgement is more important than ever!