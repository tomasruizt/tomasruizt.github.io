...
I ran the code on an NVIDIA RTX3090 GPU.
...
![Profile Without CPU-GPU Synchronization. ](./imgs/example-code-no-print-annotated.jpg){#fig-profile-do-print}
...
Passing a GPU tensor as `length` will trigger a cast to Python `int` on CPU, which introduces a CPU-GPU synchronization.
...
synchronization.
PyTorch might not provide the precise API to you need avoid the synchronization.
