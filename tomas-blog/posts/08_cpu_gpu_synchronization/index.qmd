...
I also show how to use the NVIDIA **Nsight Systems** profiler, to identify and diagnose CPU-GPU synchronization issues.
...
# Problematic Code
Other code that triggers CPU-GPU synchronizations are:

Using dynamic shapes. E.g. boolean indexing `t[bool_mask]` or `t[:gpu_index]`.
