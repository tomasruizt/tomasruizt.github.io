...
<!-- TODO
- Document the models used in end-to-end benchmarking (why these three, what they represent, parameter counts)
...
FMMS reduces TPOT by 3-29% on Qwen3-8B.
The larger hidden dimension (d=4,096 vs 2,048) means the LM head matmul is a bigger fraction of the decode step compared to Qwen3-1.7B, but still strongly memory-bound.
