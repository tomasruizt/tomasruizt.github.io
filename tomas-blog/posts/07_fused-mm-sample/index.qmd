...
- ~~Lead with strong benchmark results up front.~~ Done: restructured post to show results before algorithm.
...
FMMS is faster across all GPUs and all batch sizes from 1 to 64, with speedups of 19-37%.
...
Across typical decode batch sizes (1 to 64), FMMS is 14-65% faster.
B300 is a striking outlier: 1.5-1.7x speedups while B200/H200/H100 show 1.1-1.3x.
...
A clear pattern emerges: **FMMS is faster at all batch sizes from 1 to 64 on every GPU tested**, with speedups of 2-15%.
