...
All experiments are reproducible. The [GitHub README](https://github.com/tomasruizt/fused-mm-sample) has setup instructions and `make` targets for kernel microbenchmarks, end-to-end vLLM benchmarks, and unit tests.
