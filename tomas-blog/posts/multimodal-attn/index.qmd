...
![Visualizing Multimodal Attention](images/multimodal-attn.png){width="70%" text-align="left" fig-alt="Visualizing Multimodal Attention" .lightbox}
...
![Example 1: Induction Head Pattern](images/attn-pattern-induction-head.png){width="80%"}
