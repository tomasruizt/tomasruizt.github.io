...
**TL;DR:** In this post I describe my inference workflow with the vLLM inference engine to classify 35k videos collected from TikTok.
...
These commands are used within the SLURM file for our workload in @sec-slurm-file.
...
concurrent requests to the server. It uses a library I wrote for this purpose: [Github/tomasruizt/llm_app](https://github.com/tomasruizt/llm_app). You can find the same code in the `examples/` directory.
