...
To move your data into the LRZ AI System, they integrated a tool called [Globus Data Transfer](https://doku.lrz.de/dss-how-globus-data-transfer-and-globus-sharing-for-dss-works-11484489.html)).
...
However, the peak throughputs reported by NVIDIA vary _a lot_ depending not only on the ratio of input to output tokens, but also the total number of tokens per request, with throughputs peaks ranging from 349 to 6085 tokens/s (I report their best results in @tbl-throughput-stats).
