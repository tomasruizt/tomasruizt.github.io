...
My benchmark results in @fig-eagle3-ratios demonstrate even **greater speedups on vLLM**: around 2.0× or better at batch sizes 1 to 4.
...
The performance numbers are meant as a reference as of today (2026-01-25), and can vary with model, workload, and deployment.
