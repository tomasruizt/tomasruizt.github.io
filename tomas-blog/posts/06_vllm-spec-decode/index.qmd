...
| Family | Target Model | Draft Model(s) | EAGLE-3 Model |
|:--|:----|:---|:------|
| **Qwen3** | Qwen3-32B^[<https://huggingface.co/Qwen/Qwen3-32B>] | Qwen3-1.7B^[<https://huggingface.co/Qwen/Qwen3-1.7B>] <br> Qwen3-4B^[<https://huggingface.co/Qwen/Qwen3-4B>] | Qwen3-32B-speculator.eagle3^[<https://huggingface.co/RedHatAI/Qwen3-32B-speculator.eagle3>] |
| **LLaMa-3.3** | Llama-3.3-70B-Instruct^[<https://huggingface.co/meta-llama/Llama-3.3-70B-Instruct>] | Llama-3.2-1B^[<https://huggingface.co/meta-llama/Llama-3.2-1B>] | EAGLE3-LLaMA3.3-Instruct-70B^[<https://huggingface.co/yuhuili/EAGLE3-LLaMA3.3-Instruct-70B>] |
...
![Statistical Artifact in TTFT between SD methods and vanilla decoding.](imgs/qwen/statistical-artifact.png){width="50%" text-align="left" fig-alt="Statistical Artifact in TTFT" #fig-statistical-artifact}
...
![Regression of ITL over number of speculative tokens. The linear fit is good.](imgs/qwen/itl_k_comparison.png){width="50%" text-align="left" fig-alt="Regression of ITL over number of speculative tokens." #fig-itl-vs-num-spec-toks}
...
![TPOT Comparison between piecewise and full CUDA graphs (forecast).](imgs/qwen/tpot_k_comparison.png){width="50%" text-align="left" fig-alt="TPOT calculation" #fig-tpot-comparison-full-vs-piecewise}
