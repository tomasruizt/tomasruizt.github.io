...
The number of speculative tokens $K$ is chosen to maximize the speedup ratio.
In the next section, we see what happens when we change $K$.

::: {.panel-tabset group="dataset"}
# MT-Bench
![Token Throughput Metrics.](imgs/qwen/mt-bench/total_token_throughput_short.png){width="60%" text-align="left" fig-alt="Token throughput metrics" #fig-total-token-throughput-short}
...
![Token Throughput Metrics.](imgs/llama70b/InstructCoder/total_token_throughput_short.png){width="60%" text-align="left" fig-alt="Token throughput metrics"}
:::
...
::: {.panel-tabset group="dataset"}
# MT-Bench
![Throughput as a function of $K$, evaluating both the 1.7 and the 4B models as draft models.](imgs/qwen/mt-bench/draft_model_ratios.png){#fig-draft-model-ratios}
...
# InstructCoder (LLaMa 70B)
![Throughput as a function of $K$, evaluating both the 1.7 and the 4B models as draft models.](imgs/llama70b/InstructCoder/draft_model_ratios.png){width="60%"}
:::

The results show several key patterns:

- **Draft model size trade-off**: The 1.7B model generally achieves higher speedups than the 4B model.
...
- **Low $K$ behavior**: For low $K$ values (e.g., $K=1$), speedups are lower at small batch sizes, but performance degradation at larger batch sizes is less pronounced.
...
::: {.panel-tabset group="dataset"}
# MT-Bench
![Speedup ratios of EAGLE-3](imgs/qwen/mt-bench/eagle3_ratios.png){width="60%" text-align="left" fig-alt="Speedup ratios of EAGLE-3" #fig-eagle3-ratios}
...
# InstructCoder (LLaMa 70B)
![Speedup ratios of EAGLE-3](imgs/llama70b/InstructCoder/eagle3_ratios.png){width="60%" text-align="left" fig-alt="Speedup ratios of EAGLE-3"}
:::
...
::: {.panel-tabset group="dataset"}
# MT-Bench
![Comparison of Speedups of Draft Model and EAGLE-3](imgs/qwen/mt-bench/draft_model_vs_eagle3_ratios.png){width="60%" text-align="left" fig-alt="Comparison of Speedups of Draft Model and EAGLE-3" #fig-draft-model-vs-eagle3-ratios}
...
# InstructCoder (LLaMa 70B)
![Comparison of Speedups of Draft Model and EAGLE-3](imgs/llama70b/InstructCoder/draft_model_vs_eagle3_ratios.png){width="60%" text-align="left" fig-alt="Comparison of Speedups of Draft Model and EAGLE-3"}
:::
...
::: {.panel-tabset group="dataset"}
# MT-Bench
![Acceptance Lengths for draft_model and EAGLE-3. For draft_model, the acceptance lengths of the 4B model are higher than for the 1.7B model.](imgs/qwen/mt-bench/acceptance_length_vs_num_spec_toks.png){width="90%" text-align="left" fig-alt="Acceptance Lengths for draft_model and EAGLE-3" #fig-acceptance-lengths-vs-num-spec-toks}

# InstructCoder
![Acceptance Lengths for draft_model and EAGLE-3. For draft_model, the acceptance lengths of the 4B model are higher than for the 1.7B model.](imgs/qwen/InstructCoder/acceptance_length_vs_num_spec_toks.png){width="90%" text-align="left" fig-alt="Acceptance Lengths for draft_model and EAGLE-3"}

# InstructCoder (LLaMa 70B)
![Acceptance Lengths for draft_model and EAGLE-3. For draft_model, the acceptance lengths of the 4B model are higher than for the 1.7B model.](imgs/llama70b/InstructCoder/acceptance_length_vs_num_spec_toks.png){width="90%" text-align="left" fig-alt="Acceptance Lengths for draft_model and EAGLE-3"}
:::
...
::: {.panel-tabset group="dataset"}
# MT-Bench
![Token Throughputs of all Methods](imgs/qwen/mt-bench/total_token_throughput_full.png){width="60%" text-align="left" fig-alt="Token Throughputs of all Methods" #fig-total-token-throughput-full}
...
# InstructCoder (LLaMa 70B)
![Token Throughputs of all Methods](imgs/llama70b/InstructCoder/total_token_throughput_full.png){width="60%" text-align="left" fig-alt="Token Throughputs of all Methods"}
:::
...
::: {.panel-tabset group="dataset"}
# MT-Bench
![Inference Metrics. 99th percentile of TPOT, ITL, and TTFT. Lower is better.](imgs/qwen/mt-bench/ttft_itl_tpot.png){width="100%" text-align="left" fig-alt="Inference Metrics" #fig-ttft-itl-tpot}
...
# InstructCoder (LLaMa 70B)
![Inference Metrics. 99th percentile of TPOT, ITL, and TTFT. Lower is better.](imgs/llama70b/InstructCoder/ttft_itl_tpot.png){width="100%" text-align="left" fig-alt="Inference Metrics"}
:::
