...
On MT-Bench and InstructCoder, it delivers substantial speedups (up to 2.24x) without specialized training.
Speedups are most pronounced at smaller batch sizes and fade at larger batch sizes.
The performance numbers are meant as a reference as of today (2026.01.25), and can vary with model and deployment.
