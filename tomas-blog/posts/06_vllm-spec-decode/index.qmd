...
The EAGLE-3 paper by @li2025eagle shows speedup ratios on SGLang^[https://github.com/sgl-project/sglang] of between 1.38x and 1.82x, at batch sizes ranging from 2 to 64 (table 3, MT-Bench dataset, GPU=H100).
...
I use the same dataset and GPU.
In summary: EAGLE-3 works very well on vLLM, and is a strong baseline to compare the draft_model implementation against.

![Speedup ratios of EAGLE-3](imgs/eagle3_ratios.png){width="60%" text-align="left" fig-alt="Speedup ratios of EAGLE-3" #fig-eagle3-ratios}

Now let's compare the speedups of the draft_model implementation against EAGLE-3. 
@fig-draft-model-vs-eagle3-ratios shows the speedups on the MT-Bench dataset.
...
![Comparison of Speedups of Draft Model and EAGLE-3](imgs/draft_model_vs_eagle3_ratios.png){width="60%" text-align="left" fig-alt="Comparison of Speedups of Draft Model and EAGLE-3" #fig-draft-model-vs-eagle3-ratios}
...
![Acceptance Lengths for draft_model and EAGLE-3. For draft_model, the acceptance lenghts of the 4B model are higher than for the 1.7B model.](imgs/acceptance_length_vs_num_spec_toks.png){width="90%" text-align="left" fig-alt="Acceptance Lengths for draft_model and EAGLE-3" #fig-acceptance-lengths-vs-num-spec-toks}
