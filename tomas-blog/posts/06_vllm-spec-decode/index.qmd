...
@fig-draft-model-vs-eagle3-ratios shows the speedups on the `likaixin/InstructCoder` dataset.
...
@fig-ttft-itl-tpot shows the 99th percentile of these metrics for both SD methods and vanilla decoding on the `likaixin/InstructCoder` dataset.
