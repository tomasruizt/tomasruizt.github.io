...
sidebar:
  image: portrait-smiling-square.jpeg
  #image: one-px-img.jpeg
  sections: 
    - name: Contact
      items:
        - icon: map-marker
...
Research assistant at the LMU Munich at the the intersection of Machine Learning and Social Media, particularly on multi-modal ML. In previous jobs, I worked as a software engineer in different companies and Startups.
...
tibble::tribble(
    ...
    "Research Assistant", "Computational Social Sciences (Prof. Schwemmer)\nLudwig Maximilian University of Munich", "06/2024 - Present", "I apply large multi-modal models (VLMs) to understand and classify content from social media (videos, images, audio, \\& text). Our project 'ToxicAInment' is funded by the Bavarian Research Institute for Digital Transformation (bidt). ",
